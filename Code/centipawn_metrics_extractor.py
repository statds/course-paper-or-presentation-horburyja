...
engine = chess.engine.SimpleEngine.popen_uci("C:\Users\james\Python-Dev\stockfish_15_win_x64_avx2\stockfish_15_win_x64_avx2.exe")
...
for game in tqdm(my_list):
    ...
    try:
        ...
        finalDf.to_pickle('your_pickle_file.pkl')
...
finish = datetime.now()
print('The entire job took: {}'.format(finish - start))
